...
public class PetclinicInitializer extends AbstractDispatcherServletInitializer {
    ...
    protected WebApplicationContext createRootApplicationContext() {
        ...
        rootAppContext.setConfigLocations("classpath:core/spring/business-config.xml", "classpath:spring/tools-config.xml");
    ...
    protected WebApplicationContext createServletApplicationContext() {
        ...
        webAppContext.setConfigLocation("classpath:core/spring/mvc-core-config.xml");
